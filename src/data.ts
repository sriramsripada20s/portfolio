...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'Built a natural-language BI agent integrating Snowflake Cortex with Claude LLM via LangChain. Business users query dashboards in plain English — the agent translates to SQL, executes on Snowflake, and returns insights in seconds. Streamlit demo coming soon.',
    longDescription: `Conversational BI agent eliminating the bottleneck between business teams and data.`,
    tech: ['Snowflake Cortex', 'Claude LLM', 'LangChain', 'Python', 'FastAPI', 'Streamlit', 'Snowflake', 'SQL'],
    metrics: [
    ...
    tabs: [
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              'dbt docs exported as schema context — all models with column descriptions',
      ...
      },
      {
        ...
        sections: [
          {
            title: 'Streamlit Demo — Coming Soon',
            content: 'A live interactive Streamlit app is in development — type any business question in plain English and watch the agent translate it to SQL, execute on Snowflake, and return a structured answer in real time.',
            bullets: [
